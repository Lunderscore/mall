$(document).on("click", "[uoid]", function(){
    ...
    $.get(APP_PATH + "/delOrder", {uoid:uoid}, function(){
        location.href = APP_PATH + "/shoppingCar";
    });
});

$("#confirmItem").on("click", function(){
    $.post(APP_PATH + "/getUserAddress",function(data){
...
$("#delBatchBtn").on("click", function(){
    ...
    $.get(APP_PATH + "/delOrderBatch", {uoid:uoid}, function(){
        location.href = APP_PATH + "/shoppingCar";
    });
});
