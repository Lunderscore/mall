...
public interface IpAddressSearchWebServiceSoap {
     ...
     * @param theIpAddress
     * @return
     *     returns com.ou.mall.webservice.ip.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getCountryCityByIp", targetNamespace = "http://WebXml.com.cn/", className = "com.ou.mall.webservice.ip.GetCountryCityByIp")
    @ResponseWrapper(localName = "getCountryCityByIpResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.ou.mall.webservice.ip.GetCountryCityByIpResponse")
    ...
    @RequestWrapper(localName = "getGeoIPContext", targetNamespace = "http://WebXml.com.cn/", className = "com.ou.mall.webservice.ip.GetGeoIPContext")
    @ResponseWrapper(localName = "getGeoIPContextResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.ou.mall.webservice.ip.GetGeoIPContextResponse")
    ...
    @RequestWrapper(localName = "getVersionTime", targetNamespace = "http://WebXml.com.cn/", className = "com.ou.mall.webservice.ip.GetVersionTime")
    @ResponseWrapper(localName = "getVersionTimeResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.ou.mall.webservice.ip.GetVersionTimeResponse")
